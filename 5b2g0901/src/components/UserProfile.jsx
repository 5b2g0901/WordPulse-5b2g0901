...
export default function UserProfile() {
  return (
    ...
    >
      {/* 🌟 ĐOẠN FIX LỖI TRIỆT ĐỂ: Ép khối bên trái hiển thị đúng màu #E0F2FE bằng !important */}
      <style>{`
        .user-profile-left-block,
        .user-profile-left-block h2,
        .user-profile-left-block p,
        .user-profile-left-block strong {
          color: #E0F2FE !important; /* Ép toàn bộ tiêu đề, chữ thường, chữ đậm sang màu xanh nhạt */
        }
        
        /* Giữ nguyên cấu hình font chữ cho khối bên phải */
      ...
      <div
        className="user-profile-left-block" /* Thêm class để thẻ style ở trên nhận diện và ép màu */
        style={{
          width: "300px",
          background: "#3F5F94",
          padding: "40px 24px",
      ...
      >
        ...
        <h2
          style={{
            ...
            fontSize: "18px",
            letterSpacing: "1px",
            borderBottom: "2px dashed #E0F2FE", 
            paddingBottom: "12px",
            width: "100%"
          }}
        >
        ...
        >
          <p style={{ margin: 0 }}>
            <strong style={{ fontWeight: "700" }}>姓名:</strong> 黃詩玥
          </p>
          <p style={{ margin: 0 }}>
      ...
      {/* KHỐI PHẢI (RIGHT): Nội dung thiết kế dạng Grid thoáng đãng */}
      <div
      ...
      >
        {/* Tên sinh viên */}
        <h1 style={{ fontSize: "36px", fontWeight: "800", color: "#1E293B", margin: "0 0 20px 0" }}>
          黃詩玥
        </h1>

        {/* Tiêu đề lớn của phần thuyết minh */}
        <h2
          className="theme-title-kaiti"
          style={{
            fontWeight: "bold",
            fontSize: "20px",
            color: "#1E3A8A",
            margin: "0 0 14px 0",
            borderBottom: "2px solid #3F5F94",
            paddingBottom: "6px"
          }}
        >
